...
CM_C_STRING cfg_file::read(const CM_C_STRING namespace_name, const CM_C_STRING line_name)
{
    CM_STRING output = standard_string();
...
void cfg_file::change_value(const CM_C_STRING line_name, const CM_C_STRING value)
{
    bool _bool = false;
...
void cfg_file::change_value(const CM_C_STRING namespace_name, const CM_C_STRING line_name,
                            const CM_C_STRING value)
{
    bool _bool = false;
